...
def submit_reply(request):
    if request.method == 'POST':
        ...
        return redirect('suggestions:user_suggestions')  # Redirect to the user suggestions page or another page
...
def user_submitted_suggestions(request):
    ...
    return render(request, 'suggestions/user_submitted_suggestions.html', context)