...
from BlogApp.forms import (CommentAttachmentForm, CommentForm, PostForm,
                           ReportForm, SuggestionForm)
    ...
    if request.method == "POST":
        ...
        if "submit_comment" in request.POST:
            ...
            if comment_form.is_valid():
                ...
                # Handle attachments
                attachment_form = CommentAttachmentForm(
        ...
        )  # Initialize an empty form for attachments
...
def suggest_post(request, post_id):
    ...
    )  # Redirect to the post detail view if not POST
...
def show_likes(request):
    ...
    return render(request, "posts/post_likes.html", {"posts": posts})